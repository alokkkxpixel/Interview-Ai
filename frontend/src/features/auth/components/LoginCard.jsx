...
export function LoginCard() {
  ...
  return (
      ...
      <CardHeader className="pb-6 pt-10">
        <CardTitle className="text-xl font-bold sm:text-2xl">Login to your account</CardTitle>
        <CardDescription>
          Enter your email below to login to your account
        </CardDescription>
        <CardAction>
          <Button onClick={() => navigate('/auth/register')} variant="link">Sign Up</Button>
        </CardAction>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleLoginUser}>
          <div className="flex flex-col gap-6  py-5 px-2">
            ...
            <div className="grid gap-2">
              ...
              <Input id="password" type="password" className="bg-gray-100 py-4 px-3" required 
              value={password}
      ...
      <CardFooter className="flex-col gap-2 px-5  py-5">
        <Button onClick={handleLoginUser} disabled={emailorusername === "" || password === ""} type="submit" className="w-full">
          {loading ? <div className="flex items-center gap-2"><Spinner /> <p>Login</p></div> : "Login"}
        </Button>
